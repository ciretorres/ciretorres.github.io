...
const mostrarProyectos = ref(false)
</script>
      ...
      <ul>
        <li>
          <a class="" rel="noopener noreferrer">
            Web Frontend <span class="color-yellow">[Conahcyt]</span></a
          >
        </li>
        <ul>
          <li>
            <a
              ...
              >Generador y visualizador de Mapas</a
            >
          </li>
        </ul>
        <ul>
        ...
        <ul>
          <li>
            <span
              ...
              >Ecosistemas Nacionales Informáticos,</span
            >
        ...
        <li>
          <router-link class="color-white" to="/development/visualization/intro">
