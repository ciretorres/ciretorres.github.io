<template>
  <main id="principal" class="expediciones-trotamundos">
    <a class="portafolio" href="http://etrotamundos.com/" target="_blank" rel="noopener noreferrer">
      <img class="img-portafolio" src="@/assets/imgs/portafolio-etrota-1.webp" loading="lazy" alt="" />
      <img class="img-portafolio" src="@/assets/imgs/portafolio-etrota-2.webp" loading="lazy" alt="" />
      <img class="img-portafolio" src="@/assets/imgs/portafolio-etrota-3.webp" loading="lazy" alt="" />
    </a>
